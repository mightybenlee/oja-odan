...
const App: React.FC = () => {
  ...
  const renderAuth = (isReg: boolean) => (
    <div className="flex flex-col h-full p-8 animate-in overflow-y-auto no-scrollbar">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-white/40 text-[10px] uppercase font-black tracking-[0.5em] mt-2 italic">Authentication Hub</p>
      </div>
      <GlassCard className="p-8 border-white/20">
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex justify-center gap-8">
            <button onClick={() => handleSocialAuth('google')} className="p-4 glass-panel rounded-2xl"><Chrome className="text-white/40 hover:text-white" size={20} /></button>
            <button onClick={() => handleSocialAuth('facebook')} className="p-4 glass-panel rounded-2xl"><Facebook className="text-white/40 hover:text-white" size={20} /></button>
            <button onClick={() => handleSocialAuth('apple')} className="p-4 glass-panel rounded-2xl"><Apple className="text-white/40 hover:text-white" size={20} /></button>
          </div>
        </div>
      </GlassCard>
    </div>
  ...
  const renderHome = () => (
    <div className="flex flex-col h-full pt-8 pb-32 px-5 overflow-y-auto no-scrollbar animate-in">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-black italic tracking-tighter text-white uppercase">OJA-ODAN</h1>
      ...
      <div className="space-y-6">
        <GlassCard className="p-0 overflow-hidden border-white/5 shadow-2xl">
          ...
          <div className="px-5 pb-4 text-left"><p className="text-sm leading-relaxed text-white/80">Connecting with our roots while building the future. Today feels like a new beginning in the sanctuary! ✨🌿</p></div>
  ...
  const renderProfile = () => (
    <div className="flex flex-col h-full p-8 pb-32 animate-in text-center">
      <div className="mt-16 mb-12">
        <div className="w-40 h-40 rounded-full border-4 border-indigo-500/30 p-1 mx-auto mb-8 shadow-2xl">
