    ...
    <div className="flex flex-col h-full pt-4 pb-24 px-4 overflow-y-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        >
          ...
          <div>
            <h2 className="font-bold text-lg leading-tight group-hover:text-pink-300 transition-colors uppercase tracking-widest text-white">Oja-odan</h2>
      ...
      <div className="relative mb-8">
        ...
        <input 
          type="text" 
          placeholder="Search..." 
          className="w-full pl-12 pr-4 py-3 rounded-2xl glass-input outline-none focus:border-white/40 transition-all text-white"
        />
      </div>

      <div className="grid grid-cols-1 gap-4">
        {menuItems.map((item, index) => (
          <GlassCard key={index} className="flex items-center gap-4 hover:bg-white/15 transition-colors cursor-pointer text-white">
      ...
      <GlassCard className="mt-6 bg-gradient-to-r from-purple-500/20 to-pink-500/20 text-white">
